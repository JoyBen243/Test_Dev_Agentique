  ...
  const slides = [
    {
      ...
      description: "Une application de gestion de vie 100% hors-ligne (SQLite) conçue pour une discipline personnelle sans faille.",
      icon: Watch,
    ...
    },
    {
      ...
      description: "Alertes sonores au début/fin de chaque tâche, résumé du matin (5h15-7h00) et bilan du soir à 19h30.",
      icon: Volume2,
