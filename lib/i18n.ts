...
export const translations = {
  FR: {
    ...
    beep_sound_title: "Bip sonore des tâches",
    beep_sound_desc: "Son joué lors des changements de statut",
    beep_doux: "Doux & Cristallin",
    beep_moderne: "Moderne (Double bip)",
    beep_energique: "Énergique (Arpège)",
    beep_subtil: "Subtil (Goutte Zen)",
    alarms_system_note: "Les briefings matinaux et résumés du soir utilisent la sonnerie d'alarme configurée sur votre téléphone.",
  ...
  EN: {
    ...
    beep_sound_title: "Task beep sound",
    beep_sound_desc: "Sound played on task status change",
    beep_doux: "Soft & Clear",
    beep_moderne: "Modern (Dual beep)",
    beep_energique: "Energetic (Arpeggio)",
    beep_subtil: "Subtle (Zen Drop)",
    alarms_system_note: "Morning briefings and evening reviews use the alarm sound configured on your phone.",
  ...
  SW: {
    ...
    beep_sound_title: "Sauti ya arifa ya kazi",
    beep_sound_desc: "Mlio unaolia wakati wa mabadiliko ya hali ya kazi",
    beep_doux: "Laini & Safi",
    beep_moderne: "Ya Kisasa (Bip Mbili)",
    beep_energique: "Yenye Nguvu (Arpeggio)",
    beep_subtil: "Taratibu (Toni ya Zen)",
    alarms_system_note: "Mawaidha ya asubuhi na muhtasari wa jioni hutumia mlio wa kengele uliowekwa kwenye simu yako.",
